      ...
      {isSidebarOpen && (
        <aside className="sidebar">
          ...
          <ul>
            ...
            <li><a href="/duckcurve">Duck Curve</a></li>
          </ul>
        </aside>
      )}
